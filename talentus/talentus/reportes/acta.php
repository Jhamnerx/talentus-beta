...
if (isset($_SERVER["REQUEST_URI"])) {
    ...
    if (count($url) > 4) {
       ...
       // var_dump($acta);
        ...
        <head>
            ...
            <link rel="stylesheet" href="../'.Utiles::versionFile('../reportes/acta.css').'" type="text/css">
    ...
    //TIPO CLIENTE
        ...
        if ($cliente["apellido"] == "null" || $cliente["apellido"] == "NULL") {
        ...
        if ($dispositivo["modelo"] == "FMU130-3G" || $dispositivo["modelo"] == "FMC130-4G") {
            
            $tecnologia = "3G";
            
            if($dispositivo["modelo"] == "FMC130-4G"){
                $tecnologia = "4G";
            }

            $certifica = ' 
                    <p align="justify"><b>TALENTUS TECHNOLOGY EIRL</b>, con RUC 20496172168, Certifica que nuestro cliente:
                    <b>'.$nombre_cliente.'</b>'.$tipo_cliente.' '.$cliente["num_documento"].', ha adquirido  equipo GPS modelo '.$dispositivo["modelo"].', Teltonika el cual se encuentra transmitiendo a nuestra Plataforma de Monitoreo satelital entiempo real y cuenta con las siguientes características:</p>
                    <br>
                    <ul style="line-height: 1.7">
                    <li><b>- Condición de manejo: frenado, aceleración y girado brusco.</b></li>
                    <li><b>- Tecnología '.$tecnologia.' y memoria interna de 128 MB, que permite grabar en zonas sin cobertura.</b></li>
                    <li><b>- Detección de bloqueos de GPS, batería baja.</b></li>
                    <li><b>- Alarma sonora cuando excede la velocidad permitida.</b></li>
                    </ul>
                    <br>
       ...
       if ($dispositivo["modelo"] == "FMU130-3G" || $dispositivo["modelo"] == "FMC130-4G") {
           $descripcion = '<table class="descripcion" style=" position:absolute; top:450px; font-family:Arial, Helvetica, sans-serif; left:200px; color: #000;">';
       }else{
        $descripcion = '<table class="descripcion" style=" position:absolute; top:370px; font-family:Arial, Helvetica, sans-serif; left:200px; color: #000;">';
       }
