...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $url; ?>vistas/bower_components/datatables.net/css/jquery.dataTables.min.css">
  ...
  <link rel="stylesheet" href="<?php echo $url; ?>vistas/bower_components/datatables.net/css/buttons.dataTables.min.css">
  ...
  <link rel="stylesheet" href="<?php echo $url;
                                Utiles::auto_version('vistas/css/plantilla.css'); ?>" type="text/css">
  <link rel="stylesheet" href="<?php echo $url;
                                Utiles::auto_version('vistas/css/login.css'); ?>" type="text/css">
  <link rel="stylesheet" href="<?php echo $url;
                                Utiles::auto_version('vistas/css/formstyle.css'); ?>" type="text/css">
  <link rel="stylesheet" href="<?php echo $url;
                                Utiles::auto_version('vistas/css/usuarios.css'); ?>" type="text/css">
  <link rel="stylesheet" href="<?php echo $url;
                                Utiles::auto_version('vistas/css/whatsapp.css'); ?>" type="text/css">
  <link rel="stylesheet" href="<?php echo $url;
                                Utiles::auto_version('vistas/css/slide.css'); ?>" type="text/css">
  ...
  <!-- Font Awesome -->
<script src="https://kit.fontawesome.com/6878b3cefe.js" crossorigin="anonymous"></script>
  <!-- AdminLTE App -->
  ...
  <script src="<?php echo $url; ?>vistas/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js">
  </script>
  ...
  <script src="<?php echo $url; ?>vistas/bower_components/datatables.net-bs/js/jszip.min.js"></script>
  <script src="<?php echo $url; ?>vistas/bower_components/datatables.net-bs/js/buttons.html5.min.js"></script>
  <script src="<?php echo $url; ?>vistas/bower_components/datatables.net-bs/js/buttons.print.min.js"></script>
  ...
  <script src="<?php echo $url; ?>vistas/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js">
  </script>
  ...
  <!-- POP UP -->
  <script src="<?php echo $url; ?>vistas/js/plugins/magnific-popup/jquery.magnific-popup.min.js"></script>
  <link rel="stylesheet" href="<?php echo $url; ?>vistas/css/plugins/magnific-popup/magnific-popup.min.css">

  <!-- leaflet -->

  <script src="<?php echo $url; ?>vistas/js/plugins/leaflet/leaflet.js"></script>

  <link rel="stylesheet" href="<?php echo $url; ?>vistas/js/plugins/leaflet/leaflet.css">

  <!-- push JS -->
  <script src="<?php echo $url; ?>vistas/js/plugins/pushjs/push.min.js"></script>
  <script src="<?php echo $url; ?>vistas/js/plugins/pushjs/serviceWorker.min.js"></script>
...
if (isset($_SESSION["validarSesion"]) && $_SESSION["validarSesion"] == "ok") {
  echo '<body class="hold-transition skin-yellow-light sidebar-mini login-page">';
  ...
  if (isset($_GET["ruta"])) {
    ...
    if (
      ...
      $rutas[0] == "mensajes" ||
      $rutas[0] == "slide" ||
      $rutas[0] == "certificado-velocimetro" ||
      $rutas[0] == "certificado"
    ) {
...
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/plantilla.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorPersona.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorCategorias.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorServicios.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorAlmacenes.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorProveedor.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorClientes.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorIngresos.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorVentas.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorUsuarios.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorDispositivos.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorContratos.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorVehiculos.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorFlotas.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorContacto.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorActas.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorCiudad.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorCertificados.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorCobros.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorNotificaciones.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorRoles.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorLineas.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorTareas.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorTecnicos.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorRecibos.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorSlide.js'); ?>"></script>
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorMensajes.js'); ?>"></script>
