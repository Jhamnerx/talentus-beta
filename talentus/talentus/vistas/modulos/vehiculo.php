          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-6 col-xs-12 addAlert">
              ...
              <div class="input-group">
                ...
                <input type="tel" class="form-control comprobarSim input-md sim" placeholder="Num Sim" name="sim">
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <input type="tel" class="form-control input-md idgps idgps" placeholder="ID GPS" name="idgps">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-6 col-xs-12 addAlert">
              ...
              <div class="input-group">
                ...
                <input type="tel" class="form-control input-md editarSim" placeholder="Num Sim" name="editarSim">
