...
<input type="hidden" class="permisoAdministrador" value='<?php echo $_SESSION["administracion"]; ?>'>
...
<div class="col-xs-12 col-sm-8">
  <div class="box box-info">
    ...
    <div class="box-footer clearfix">
        ...
        <a class="btn btn-sm btn-info btn-flat pull-left modalCrearTarea" data-toggle="modal" data-target="#modalCrearTarea">Crear Tarea</a>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              ======================================-->
              <?php
                  $listaSelect = ControladorTareas::ctrMostrarPlacas();
              ?>

              <input type="hidden" class="autocompletePlaca" value='<?php echo $listaSelect;?>'>



              <input type="text" id="autocompletePlaca-ajax" class="form-control input-md idVehiculo" value="" placeholder="Busca la placa" name="idVehiculo" required>
              <input type="hidden" class="placaIdVehiculo" name="placaIdVehiculo">
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-cog"></i></span>
                  ...
                  <select name="dispositivo" class="form-control dispositivo" data-live-search="true">
...
<div id="modalEditarTipoTarea" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <input type="hidden" class="form-control input-md editarIdTipoTarea" name="editarIdTipoTarea"> 

                <input type="text" class="form-control input-md editarTipoTarea" name="editarTipoTarea"> 
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-md editarCostoTarea" name="editarCostoTarea"> 
      ...
      <?php 
       $editarTipoTarea = new ControladorTareas;
       $editarTipoTarea -> ctrEditarTipoTarea();
       ?>
          ...
          <div class="box-body">
            ...
            <div class="form-group col-xs-12">
              ...
              <div class="input-group">
                ...
                <input type="hidden" class="idEditarTarea"  name="idEditarTarea"> 
                <select type="text" class="form-control input-md EditarTipoTarea" name="EditarTipoTarea" required>
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <input type="hidden" readonly="" class="form-control input-md editarIdVehiculo" name="editarIdVehiculo"> 
                <input type="text" readonly="" class="form-control input-md tareaVerPlaca"  name="tareaVerPlaca"> 
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-cog"></i></span>
                  ...
                  <select name="editarDispositivo" class="form-control editarDispositivo" data-live-search="true">
                  <?php 

                  $dispo = ControladorDispositivos::ctrMostrarDispositivos(null, null);
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <input maxlength="9" type="text" class="form-control input-md editarSimTarea" name="editarSimTarea"> 
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-md editarSimCardTarea" name="editarSimCardTarea"> 
            ...
            <div class="form-group col-sm-6 col-xs-12 divEditarNuevo" style="display: none;">
              ...
              <div class="input-group">
                ...
                <input maxlength="9" type="text" class="form-control input-md editarNuevoSimTarea" name="editarNuevoSimTarea"> 
            ...
            <div class="form-group col-sm-6 col-xs-12 divEditarNuevo" style="display: none;">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-md editarNuevoSimCardTarea" name="editarNuevoSimCardTarea"> 
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control input-md editarFechaTarea" name="editarFechaTarea" id="fechaTarea" required="">
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <input type="time" class="form-control input-md editarHoraTarea" name="editarHoraTarea" id="horaTarea" required="">
              </div> 
