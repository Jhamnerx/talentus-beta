          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <textarea maxlength="600" class="form-control input-lg" name="descripcionReporte" rows="4" placeholder="Ingresar descripción reporte"></textarea>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <input type="date" class="form-control fechaReporteEditar" name="fechaReporteEditar">
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <input type="time" class="form-control horaReporteEditar" name="horaReporteEditar">
            ...
            <div class="form-group col-lg-12 col-xs-12">
              ...
              <div class="input-group" style=" width: 100%; height: 20px;">
                ...
                <textarea class="form-control input-lg informeReporte" name="informeReporte" rows="4"></textarea>
...
<script src="<?php echo $url;
              Utiles::auto_version('vistas/js/gestorReportes.js'); ?>"></script>