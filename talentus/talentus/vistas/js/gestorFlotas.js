...
ELIMINAR FLOTA
=============================================*/
$(".tablaFlotas tbody").on("click", ".btnEliminarFlota ", function(){

	var idFlota = $(this).attr("idFlota");

  	swal({
    	title: '¿Está seguro de borrar el Flota?',
    	...
    	confirmButtonColor: '#3085d6',
      	...
      	confirmButtonText: 'Si, borrar flota!'
	 }).then(function(result){

    	if(result.value){

      	window.location = "index.php?ruta=flota&idFlota="+idFlota;
