(function ($) {
    $.fn.floatingWhatsApp = function (options) {
        ...
        var $inputnumber = $(document.createElement('div'));
        //#endregion
        ...
        if (settings.showPopup) {
            ...
            $inputnumber.addClass('floating-wpp-input-number');
            $btnSend.addClass('floating-wpp-btn-send');

            $popupMessage.text(settings.popupMessage);
            $textarea.val(settings.message);
            $input.val(settings.number);
        ...
        function sendWhatsappMessage() {
            ...
            apilink += '.whatsapp.com/send?phone=' + settings.number + '&text=' + encodeURI(settings.message);
