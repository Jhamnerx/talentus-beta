...
$("#modalEditarVehiculo").on("keyup", ".editarSim", function(){
	...
	var numero = numeroVerificador;

	
	if (numeroSim != "" && numeroSim.length >=9) {
...
ELIMINAR VEHICULO
=============================================*/
$(".tablaVehiculos tbody").on("click", ".btnEliminarVehiculo", function(){
	...
	var idVehiculo = $(this).attr("idVehiculo");
  	...
  	swal({
    	...
    	if(result.value){
      	...
      	window.location = "index.php?ruta=vehiculo&idVehiculo="+idVehiculo;
