...
class ModeloVehiculos{
	...
	static public function mdlCrearVehiculosTarea($tabla, $datos){

		$dbh = Conexion::conectar();

		$stmt = $dbh->prepare("INSERT INTO $tabla(placa,marca,modelo,tipo,year,color,motor,serie,flota,sim,operador,descripcion,dispositivo,idgps,estado) VALUES (:placa,:marca,:modelo,:tipo,:year,:color,:motor,:serie,:flota,:sim,:operador,:descripcion,:dispositivo,:idgps,1)");
