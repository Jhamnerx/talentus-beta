...
class ModeloTarea{
	...
	static public function mdlCrearTarea($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_empleado, id_admin, tipo, vehiculo, sim, sim_card, nuevo_sim, nuevo_card, dispositivo ,cliente, leido, estado, fecha, hora) VALUES (:id_empleado, :id_admin, :tipo, :vehiculo, :sim, :sim_card, :nuevo_sim, :nuevo_card, :dispositivo, :cliente, 0, 1, :fecha, :hora)");
	...
	static public function mdlEditarTarea($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET tipo = :tipo, dispositivo = :dispositivo, vehiculo = :vehiculo, sim = :sim, sim_card = :sim_card, nuevo_sim = :nuevo_sim, nuevo_card = :nuevo_card, fecha = :fecha, hora = :hora WHERE id = :id");
	...
	static public function mdlEditarTipoTarea($tabla, $datos){

		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET tipo = :tipo, costo = :costo WHERE id = :id");
	...
	static public function mdlMostrarReporteTareas($tabla, $item, $fechaInicio, $fechaFin, $estado){

		$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE $item >= '$fechaInicio' AND $item <= '$fechaFin' AND estado = '$estado'");
