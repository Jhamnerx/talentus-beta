...
class ModeloSlide{	
	...
	static public function mdlCrearSlide($tabla, $datos, $orden){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(imgFondo, tipoSlide, estiloImgProducto, estiloTextoSlide, titulo1, titulo2, titulo3, boton, url, orden) VALUES (:imgFondo, :tipoSlide, :estiloImgProducto, :estiloTextoSlide, :titulo1, :titulo2, :titulo3, :boton, :url, :orden)");
