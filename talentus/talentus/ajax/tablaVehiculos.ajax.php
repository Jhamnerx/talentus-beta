  ...
  =============================================*/
 	...
 	public function mostrarTabla(){
		...
		for($i = 0; $i < count($vehiculos); $i++){
		    ...
		    $acciones = "<div class='btn-group'><button class='btn btn-warning btnEditarVehiculo' idVehiculo='".$vehiculos[$i]["id"]."' data-toggle='modal' data-target='#modalEditarVehiculo'><i class='fa fa-pencil'></i></button> <button class='btn btn-danger btnEliminarVehiculo' idVehiculo='".$vehiculos[$i]["id"]."'><i class='fa fa-times'></i></button></div>";
