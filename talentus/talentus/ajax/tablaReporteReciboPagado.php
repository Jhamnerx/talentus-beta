...
class TablaRecibos
{
	public $fechaReporteInicio;
  public $fechaReporteFin;

	public function mostrarTabla()
	{
		$item = "fechaPago";

		$recibos = ControladorRecibos::ctrMostrarReporteRecibosPagados($item, $this->fechaReporteInicio, $this->fechaReporteFin);
...
if(isset($_GET["fechaReporteInicio"])){

  $activar = new Tablarecibos();
  $activar -> fechaReporteInicio = $_GET["fechaReporteInicio"];
  $activar -> fechaReporteFin = $_GET["fechaReporteFin"];
