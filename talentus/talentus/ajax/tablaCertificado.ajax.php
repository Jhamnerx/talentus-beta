  ...
  =============================================*/ 
 	...
 	public function mostrarTabla(){
		...
		for($i = 0; $i < count($certificado); $i++){
		    ...
		    $acciones = "<div class='btn-group'><button class='btn btn-warning btnEditarCertificado' idcertificado='".$certificado[$i]["id"]."' data-toggle='modal' data-target='#modalEditarCertificado'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarCertificado idCertificado".$certificado[$i]["id"]."' idCertificado='".$certificado[$i]["id"]."' ><i class='fa fa-times'></i></button></div>";
