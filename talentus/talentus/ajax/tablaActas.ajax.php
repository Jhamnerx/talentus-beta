  ...
  =============================================*/ 
 	...
 	public function mostrarTabla(){
		...
		for($i = 0; $i < count($acta); $i++){
		    ...
		    $acciones = "<div class='btn-group'><button class='btn btn-warning btnEditarActa' idvehiculo='".$acta[$i]["idvehiculo"]."' idacta='".$acta[$i]["id"]."' data-toggle='modal' data-target='#modalEditarActa'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarActa idActa".$acta[$i]["id"]."' idActa='".$acta[$i]["id"]."' ><i class='fa fa-times'></i></button></div>";
		    ...
		    if ($vehiculo) {
		    	...
		    	$placa = "<em style='color: red'>Vehiculo Eliminado<em>";
		    }
